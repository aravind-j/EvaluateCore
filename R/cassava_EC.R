...
#' 26 (out of 62) descriptors for 1684 (out of 2170) accessions. The data for
#' quantitative traits is standardized. It is used to demonstrate the various
#' functions of \code{EvaluateCore} package.
#'
