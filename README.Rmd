...
###### Version : [`r getNamespaceVersion("EvaluateCore")`](https://aravind-j.github.io/EvaluateCore/); Copyright (C) 2018-`r  format(Sys.Date(), "%Y")`: [ICAR-NBPGR](https://nbpgr.org.in/); License: [GPL-2|GPL-3](https://www.r-project.org/Licenses/)
