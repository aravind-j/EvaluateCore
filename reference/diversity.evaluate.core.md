...
- shannon:
  ...
  :   The Effective Number of Species for Shannon-Weaver Diversity Index
      (\\ENS\_{H}\\) for EC
...
(Macarthur 1965) described the Effective number of species for the
Shannon index (\\ENS\_{H}\\) as follows.
