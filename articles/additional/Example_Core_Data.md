...
```
    ...
    ## [1] corehunter_3.2.3 rJava_1.0-18     readxl_1.4.5    
    ## 
    ## loaded via a namespace (and not attached):
    ##  [1] vctrs_0.7.3        cli_3.6.6          knitr_1.51         rlang_1.2.0       
    ##  [5] xfun_0.57          otel_0.2.0         generics_0.1.4     textshaping_1.0.5 
    ##  [9] jsonlite_2.0.0     glue_1.8.1         DT_0.34.0          htmltools_0.5.9   
    ## [13] ragg_1.5.2         sass_0.4.10        rmarkdown_2.31     cellranger_1.1.0  
    ...
    ## [25] compiler_4.6.0     dplyr_1.2.1        fs_2.1.0           pkgconfig_2.0.3   
    ...
    ## [37] tools_4.6.0        pkgdown_2.2.0.9000 cachem_1.1.0       desc_1.4.3
