...
> Possibly misspelled words in DESCRIPTION: Odong (26:53) al (26:62) et
> (26:59) germplasm (25:20)
...
- The email address of the maintainer is updated from
  ...
  send the confirmation for the same from the older email.
...
- Removed dependency on deprecated package `ccChooser`, because of which
  `EvaluateCore` was also deprecated.
...
Misspelled words in DESCRIPTION are false positives - Odong; et; al;
germplasm.
...
- Updated references in Description field of the DESCRIPTION file to
  correct format.

### Test environments

- local Windows 10 Home v1803, R-release (R 4.0.0) & R-devel (R 4.1.0
  Pre-release).

- local Ubuntu 16.04, R-release (R 4.0.0) & R-devel (R 4.1.0
  Pre-release).
...
- JRE 8 is already specified in the SystemRequirements field in
  DESCRIPTION. Added JRE syterm requirements to the README as well.
